...
* coin additions / updates: Monacoin (wakiyamap), Sparks (Mircea Rila), ColossusXT,
  Polis, MNPCoin, Zcoin, GINCoin (cronos), Grosetlcoin (gruve-p), cadex (konez2k),
...
* coin additions / updates: NMC (jeremyrand), cadex (zebra-lucky), PeerCoin (peerchemist),
...
* coin additions / updates: BitcoinSV, SmartCash (rc125), NIX (phamels), Minexcoin (joesixpack),
  BitcoinABC (mblunderburg), cadex (zebra-lucky), BitcoinABCRegtest (ezegom), AXE (slowdive),
