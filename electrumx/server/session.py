...
class SessionManager(object):
    ...
    def __init__(self, env, db, bp, daemon, mempool, shutdown_event):
        ...
        if issubclass(env.coin.SESSIONCLS, CadexElectrumX):
...
class CadexElectrumX(ElectrumX):
    '''A TCP server that handles incoming Electrum Cadex connections.'''
...
class SmartCashElectrumX(CadexElectrumX):
